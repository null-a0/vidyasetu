...
DEFAULT_USERS = [
    ...
    {
        "email": "institution.admin@vidyasetu.edu",
...
async def main() -> None:
    ...
    print("[init_db] ========================================")
    print("[init_db] Starting VidyaSetu Database Initialization")
    ...
    try:
        ...
        print("[init_db]   Email: admin@vidyasetu.edu")
