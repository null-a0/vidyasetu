                                ...
                                <div className="flex-1">
                                    {editorMode === "raw" ? (
                                        <textarea
                                            ...
                                            placeholder="Write or edit markdown content here..."
                                            className="w-full h-full resize-none border border-gray-300 rounded p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                                        />
                                    ) : (
                                        <div className="h-full border border-gray-300 rounded p-4 overflow-y-auto bg-gray-50">
                            ...
                            {isLoading ? (
                                <div className="flex items-center justify-center h-full">
                                    <div className="text-center">
                                        <div className="animate-spin text-2xl mb-3">
                                            ⏳
                                        </div>
