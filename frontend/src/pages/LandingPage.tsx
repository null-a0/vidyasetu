...
const features = [
  {
    ...
    description: "Create, manage, and track skill development workshops across institutions with real-time monitoring.",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: ClipboardList,
    title: "Smart Assessments",
    description: "Design assessments with auto-grading, analytics, and instant feedback for continuous learning.",
    color: "bg-info/10 text-info",
  },
  {
    icon: Award,
    title: "Digital Certificates",
    description: "Generate tamper-proof digital certificates with unique verification codes and QR validation.",
    color: "bg-warning/10 text-warning",
  },
  {
    icon: BarChart3,
    title: "Performance Analytics",
    description: "Deep insights into student progress, institution performance, and workshop effectiveness.",
    color: "bg-success/10 text-success",
  },
  {
    icon: Shield,
    title: "Role-Based Access",
    description: "Granular access control for admins, institutions, educators, and students with secure authentication.",
    color: "bg-destructive/10 text-destructive",
  },
  {
    icon: Bell,
    title: "Smart Notifications",
    description: "Stay updated with intelligent alerts for assessments, results, certificates, and announcements.",
    color: "bg-primary/10 text-primary",
  },
];
...
const stats = [
  ...
  { value: "2,500+", label: "Workshops", icon: BookOpen },
...
const testimonials = [
  {
    ...
    role: "Dean, IIT Delhi",
    text: "VidyaSetu has transformed how we manage skill development programs. The analytics alone saved us hundreds of hours.",
    avatar: "PS",
  },
  {
    name: "Prof. Rajesh Iyer",
    role: "Educator, NIT Trichy",
...
const pricingPlans = [
  {
    ...
    features: ["Up to 3 workshops", "50 students", "Basic assessments", "Email support"],
    highlighted: false,
  },
  {
    name: "Professional",
    ...
    features: ["Unlimited workshops", "500 students", "Advanced analytics", "Certificate generation", "Priority support"],
    highlighted: true,
  },
  {
    name: "Enterprise",
    ...
    features: ["Unlimited everything", "Custom branding", "API access", "Dedicated support", "SLA guarantee"],
    highlighted: false,
  },
];
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-extrabold tracking-tight text-foreground">VidyaSetu</span>
          </div>
          ...
          <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden p-2 rounded-xl hover:bg-accent transition-colors">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-1 p-4">
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground rounded-xl hover:bg-accent transition-all">Features</a>
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            >
              ...
              <br />
              <span className="text-foreground">with VidyaSetu</span>
            </motion.h1>
            ...
            >
              The all-in-one platform for educational institutions to manage workshops, assessments,
              certifications, and student performance — beautifully and effortlessly.
            </motion.p>
      ...
      {/* ───── Stats ───── */}
      <section id="stats" className="py-16 sm:py-20 px-4 border-t border-border/50">
      ...
      <section id="features" className="py-16 sm:py-24 px-4">
        <div className="mx-auto max-w-6xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-14">
            ...
            <motion.h2 variants={fadeUp} custom={1} className="text-3xl sm:text-4xl font-extrabold text-foreground">
              Powerful Features for Modern Education
            </motion.h2>
            <motion.p variants={fadeUp} custom={2} className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              From workshop creation to certificate verification, VidyaSetu handles the entire lifecycle of skill development programs.
            </motion.p>
          </motion.div>
          ...
          >
            {features.map(({ icon: Icon, title, description, color }, i) => (
              ...
              >
                <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${color} transition-transform group-hover:scale-110`}>
      ...
      <section id="pricing" className="py-16 sm:py-24 px-4">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.div
            ...
            className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3"
          >
            {pricingPlans.map(({ name, price, period, description, features: planFeatures, highlighted }, i) => (
              <motion.div
                key={name}
                variants={fadeUp}
                custom={i}
      ...
      <section className="py-16 sm:py-24 px-4">
        ...
        >
          ...
          <p className="relative text-primary-foreground/80 text-base sm:text-lg max-w-2xl mx-auto mb-8">
            Join hundreds of institutions already using VidyaSetu to deliver world-class skill development programs.
          </p>
          <button
            onClick={() => navigate("/signup")}
      ...
      <footer className="border-t border-border py-12 px-4">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-10">
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-lg font-extrabold text-foreground">VidyaSetu</span>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Bridging the gap between education and skill development across India.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">© 2026 VidyaSetu. All rights reserved.</p>
