export type UserRole = "admin" | "institution_admin" | "educator" | "student";
...
export const mockUsers: Record<string, AppUser> = {
  admin: { id: "u1", name: "Rajesh Verma", email: "admin@vidyasetu.com", role: "admin" },
  institution: { id: "u2", name: "Dr. Meena Sharma", email: "institution@vidyasetu.com", role: "institution_admin", institution: "IIT Delhi" },
  educator: { id: "u3", name: "Dr. Anand Kumar", email: "educator@vidyasetu.com", role: "educator", institution: "IIT Delhi" },
  student: { id: "u4", name: "Aarav Sharma", email: "student@vidyasetu.com", role: "student", institution: "IIT Delhi" },
};
